                ...
                <div key={company._id}>
                   <div className="card card-side bg-base-300 shadow-xl m-3 items-center">
                        <figure className="px-10 pt-10">
                            <img src="https://placehold.co/200x200" alt="company logo" className="rounded-xl float"></img>
                        </figure>
                        <div className="card-body items-start">
                            <h2 className="card-title text-white text-3xl">{company.name}</h2>
                            <p>{company.industry}</p>
                            <p>{company.hqState}, {company.hqCity}</p>
